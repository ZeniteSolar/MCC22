...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Vbat_comp_EXT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PB0     ------> COMP1_OUT
    */
    GPIO_InitStruct.Pin = Vbat_comp_in_EXT_Pin|Vbat_comp_EXT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Bat_OverV_Out_EXT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END COMP2_MspInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(Bat_OverV_Out_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TImer_break_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PB0     ------> COMP1_OUT
    */
    HAL_GPIO_DeInit(GPIOC, Vbat_comp_in_EXT_Pin|Vbat_comp_EXT_Pin);
