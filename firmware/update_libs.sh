...
download_libs () {
    echo "Updating..."
    wget  -q --show-progress https://raw.githubusercontent.com/ZeniteSolar/CAN_IDS/master/can_ids.h -O Core/Inc/canbus/can_ids.h
    wget  -q --show-progress https://raw.githubusercontent.com/ZeniteSolar/CAN_IDS/master/can_parser_types.h -O Core/Inc/canbus/can_parser_types.h
